...
- `project-high-performance-learning.html`
- `assets/js/hpl-results-config.js`
- `hpl-results-google-apps-script.gs`
...
4. Paste the contents of `hpl-results-google-apps-script.gs` into `Code.gs`.
...
- `project-high-performance-learning.html?admin=1`
